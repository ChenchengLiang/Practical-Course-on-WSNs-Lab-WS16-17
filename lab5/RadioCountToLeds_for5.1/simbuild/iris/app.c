...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f06c8bb7cf8, const void *arg_0x7f06c8bb6020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f06c8b36618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f06c88f08e8), 
int (*key_eq_fn)(void *arg_0x7f06c88ef0c8, void *arg_0x7f06c88ef368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f06c86ed610, int arg_0x7f06c86ed878);
static double RandomUniform(void );
...
# 41 "BlockCipherInfo.nc"
static uint8_t AES128M$BlockCipherInfo$getMaxKeyLength(void );
#line 39
static uint8_t AES128M$BlockCipherInfo$getPreferredBlockSize(void );
# 78 "BlockCipher.nc"
static error_t AES128M$BlockCipher$decrypt(CipherContext *context, 
...
# 41 "BlockCipherInfo.nc"
static uint8_t RadioCountToLedsC$BlockCipherInfo$getMaxKeyLength(void );
#line 39
static uint8_t RadioCountToLedsC$BlockCipherInfo$getPreferredBlockSize(void );
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
...
# 78 "BlockCipher.nc"
static error_t RadioCountToLedsC$BlockCipher$decrypt(CipherContext *context, 
uint8_t *cipherBlock, uint8_t *plainBlock);
#line 48
static error_t RadioCountToLedsC$BlockCipher$init(CipherContext *context, 
uint8_t blockSize, uint8_t keySize, uint8_t *key);
#line 62
static error_t RadioCountToLedsC$BlockCipher$encrypt(CipherContext *context, 
uint8_t *plainBlock, uint8_t *cipherBlock);
# 77 "RadioCountToLedsC.nc"
CipherContext RadioCountToLedsC$context[1000];
...
static const uint8_t AES128M$isbox[1000][256];
...
static void AES128M$InvSubBytes(uint8_t *state);
...
#line 107
static void AES128M$InvShiftRows(uint8_t *states[2], uint8_t *selected);
#line 119
static inline void AES128M$MixColumns(uint8_t *states[2], uint8_t *selected);
#line 161
static inline void AES128M$InvMixColumns(uint8_t *states[2], uint8_t *selected);
#line 225
...
#line 270
static inline error_t AES128M$BlockCipher$encrypt(CipherContext *context, uint8_t *in, uint8_t *out);
#line 304
static inline error_t AES128M$BlockCipher$decrypt(CipherContext *context, uint8_t *in, uint8_t *out);
#line 338
static inline uint8_t AES128M$BlockCipherInfo$getPreferredBlockSize(void );



static inline uint8_t AES128M$BlockCipherInfo$getMaxKeyLength(void );
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7f06c82e5340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f06c82e5340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7f06c82e5340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7f06c82e3020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7f06c82e3020, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7f06c82e6220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7f06c82e6220, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7f06c8032788, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f06c8032788) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7f06c8032788, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7f06c85dc020){
#line 75
  switch (arg_0x7f06c85dc020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7f06c85dc020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7f06c8031960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7f06c8031960, addr, msg, len);
#line 80
...
#line 311
  ...
  for (rnd = 10 - 1; rnd > 0; rnd--) 
    {
      AES128M$InvShiftRows(states, &i);
      AES128M$InvSubBytes(states[i]);
      AES128M$AddRoundKey(states[i], ctx->w + rnd * 4);
      AES128M$InvMixColumns(states, &i);
    }
...
# 78 "BlockCipher.nc"
inline static error_t RadioCountToLedsC$BlockCipher$decrypt(CipherContext *context, uint8_t *cipherBlock, uint8_t *plainBlock){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  __nesc_result = AES128M$BlockCipher$decrypt(context, cipherBlock, plainBlock);
#line 78
...
# 62 "BlockCipher.nc"
inline static error_t RadioCountToLedsC$BlockCipher$encrypt(CipherContext *context, uint8_t *plainBlock, uint8_t *cipherBlock){
#line 62
  unsigned char __nesc_result;
#line 62
...
# 48 "BlockCipher.nc"
inline static error_t RadioCountToLedsC$BlockCipher$init(CipherContext *context, uint8_t blockSize, uint8_t keySize, uint8_t *key){
#line 48
  unsigned char __nesc_result;
#line 48
...
# 41 "BlockCipherInfo.nc"
inline static uint8_t RadioCountToLedsC$BlockCipherInfo$getMaxKeyLength(void ){
#line 41
  unsigned char __nesc_result;
#line 41

#line 41
  __nesc_result = AES128M$BlockCipherInfo$getMaxKeyLength();
#line 41
...
inline static uint8_t RadioCountToLedsC$BlockCipherInfo$getPreferredBlockSize(void ){
#line 39
  unsigned char __nesc_result;
#line 39
...
#line 120
      ...
      BlockSize = RadioCountToLedsC$BlockCipherInfo$getPreferredBlockSize();
      KeyLength = RadioCountToLedsC$BlockCipherInfo$getMaxKeyLength();
      RadioCountToLedsC$BlockCipher$init(&RadioCountToLedsC$context[sim_node()], BlockSize, KeyLength, key);
      RadioCountToLedsC$BlockCipher$encrypt(&RadioCountToLedsC$context[sim_node()], cipherText, encryptedText);
      RadioCountToLedsC$BlockCipher$decrypt(&RadioCountToLedsC$context[sim_node()], encryptedText, decryptMsg);


      __nesc_hton_uint16(rcm->mydata.nxdata, encryptedText);
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7f06c7da3c28){
#line 83
  switch (arg_0x7f06c7da3c28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7f06c7da3c28);
#line 83
      break;
#line 83
    }
...
static void AES128M$InvSubBytes(uint8_t *state)
{
  state[0] = AES128M$isbox[sim_node()][state[0]];
#line 64
  state[1] = AES128M$isbox[sim_node()][state[1]];
#line 64
  state[2] = AES128M$isbox[sim_node()][state[2]];
#line 64
  state[3] = AES128M$isbox[sim_node()][state[3]];
  state[4] = AES128M$isbox[sim_node()][state[4]];
#line 65
  state[5] = AES128M$isbox[sim_node()][state[5]];
#line 65
  state[6] = AES128M$isbox[sim_node()][state[6]];
#line 65
  state[7] = AES128M$isbox[sim_node()][state[7]];
  state[8] = AES128M$isbox[sim_node()][state[8]];
#line 66
  state[9] = AES128M$isbox[sim_node()][state[9]];
#line 66
  state[10] = AES128M$isbox[sim_node()][state[10]];
#line 66
  state[11] = AES128M$isbox[sim_node()][state[11]];
  state[12] = AES128M$isbox[sim_node()][state[12]];
#line 67
  state[13] = AES128M$isbox[sim_node()][state[13]];
#line 67
  state[14] = AES128M$isbox[sim_node()][state[14]];
#line 67
  state[15] = AES128M$isbox[sim_node()][state[15]];
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioCountToLedsC$context"))
  {
    *addr = (uintptr_t)&RadioCountToLedsC$context[__nesc_mote];
    *size = sizeof(RadioCountToLedsC$context[__nesc_mote]);
    return 0;
  }
...
#line 24
  ...
  if (!strcmp(varname, "AES128M$isbox"))
  {
    *addr = (uintptr_t)&*(unsigned char (*)
#line 25
    [256])&AES128M$isbox[__nesc_mote];
    *size = sizeof(*(unsigned char (*)
#line 25
    [256])&AES128M$isbox[__nesc_mote]);
    return 0;
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioCountToLedsC */
  memset((void *)&RadioCountToLedsC$context[__nesc_mote], 0, sizeof RadioCountToLedsC$context[__nesc_mote]);
  ...
  memcpy((void *)&*(unsigned char (*)[256])&AES128M$isbox[__nesc_mote], (void *)&(unsigned char const [256]){  }, sizeof *(unsigned char (*)[256])&AES128M$isbox[__nesc_mote]);
