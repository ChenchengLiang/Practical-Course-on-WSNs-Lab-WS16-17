...
public class RadioCountMsg extends net.tinyos.message.Message {
    ...
    public String toString() {
      ...
      try {
        s += "  [mydata=0x"+Long.toHexString(get_mydata())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    }
     ...
     */
    public static boolean isSigned_mydata() {
        return false;
    }
     ...
     */
    public static boolean isArray_mydata() {
        return false;
    }
     ...
     */
    public static int offset_mydata() {
        return (16 / 8);
    }
     ...
     */
    public static int offsetBits_mydata() {
        return 16;
    }
     ...
     */
    public int get_mydata() {
        return (int)getUIntBEElement(offsetBits_mydata(), 16);
    }

    /**
     * Set the value of the field 'mydata'
     */
    public void set_mydata(int value) {
        setUIntBEElement(offsetBits_mydata(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'mydata'
     */
    public static int size_mydata() {
        return (16 / 8);
    }
     ...
     */
    public static int sizeBits_mydata() {
        return 16;
    }
