...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f6a185e2cf8, const void *arg_0x7f6a185e1020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f6a18561618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f6a1831b8e8), 
int (*key_eq_fn)(void *arg_0x7f6a1831a0c8, void *arg_0x7f6a1831a368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f6a18118610, int arg_0x7f6a18118878);
static double RandomUniform(void );
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7f6a17d11340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f6a17d11340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7f6a17d11340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7f6a17d0f020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7f6a17d0f020, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7f6a17d12220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7f6a17d12220, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7f6a17a7fe18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f6a17a7fe18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7f6a17a7fe18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7f6a18007020){
#line 75
  switch (arg_0x7f6a18007020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7f6a18007020);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7f6a17a7c020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7f6a17a7c020, addr, msg, len);
#line 80
...
#line 126
# 98 "RadioCountToLedsC.nc"
static inline void RadioCountToLedsC$MilliTimer$fired(void )
#line 98
{
  RadioCountToLedsC$counter[sim_node()]++;
  sim_log_debug(152U, "RadioCountToLedsC", "RadioCountToLedsC: timer fired, counter is %hu.\n", RadioCountToLedsC$counter[sim_node()]);
...
#line 113
          sim_log_debug(153U, "RadioCountToLedsC", "\n");
          sim_log_debug(154U, "RadioCountToLedsC", "Sender ID: %hhu\n", Sender_ID);
          sim_log_debug(155U, "RadioCountToLedsC", "RadioCountToLedsC: packet sent.\n", RadioCountToLedsC$counter[sim_node()]);
          sim_log_debug(156U, "RadioCountToLedsC", "Time: %s\n", sim_time_string());
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7f6a177eec28){
#line 83
  switch (arg_0x7f6a177eec28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7f6a177eec28);
#line 83
      break;
#line 83
    }
...
#line 76
{
  ...
  sim_log_debug(150U, "RadioCountToLedsC", "Application booted (second message).\n");
  sim_log_debug(151U, "Boot", "Application booted (third message).\n");
  RadioCountToLedsC$AMControl$start();
}
