...
public class DataMsg extends net.tinyos.message.Message {
    ...
    public String toString() {
      ...
      try {
        s += "  [TOS_NODE_ID=0x"+Long.toHexString(get_TOS_NODE_ID())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    }
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: TOS_NODE_ID
    //   Field type: int, unsigned
    //   Offset (bits): 128
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'TOS_NODE_ID' is signed (false).
     */
    public static boolean isSigned_TOS_NODE_ID() {
        return false;
    }

    /**
     * Return whether the field 'TOS_NODE_ID' is an array (false).
     */
    public static boolean isArray_TOS_NODE_ID() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'TOS_NODE_ID'
     */
    public static int offset_TOS_NODE_ID() {
        return (128 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'TOS_NODE_ID'
     */
    public static int offsetBits_TOS_NODE_ID() {
        return 128;
    }

    /**
     * Return the value (as a int) of the field 'TOS_NODE_ID'
     */
    public int get_TOS_NODE_ID() {
        return (int)getUIntBEElement(offsetBits_TOS_NODE_ID(), 16);
    }

    /**
     * Set the value of the field 'TOS_NODE_ID'
     */
    public void set_TOS_NODE_ID(int value) {
        setUIntBEElement(offsetBits_TOS_NODE_ID(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'TOS_NODE_ID'
     */
    public static int size_TOS_NODE_ID() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'TOS_NODE_ID'
     */
    public static int sizeBits_TOS_NODE_ID() {
        return 16;
    }
